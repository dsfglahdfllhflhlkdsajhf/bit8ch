...
client.on('message', message => {
	...
	.setColor("RANDOM")
        ...
        .addField("- unmute :", "**Unmute A mentioned user**, **__Example: #unmute @Ryu...#5498__**")
        ...
        .addField("- mutevoice :", "**Give A mentioned user server mute**, **__Example: #mutevoice @Ryu...#5498__**")
		.addField("- unmutevoice :", "**Unmute A mentioned user**, **__Example: #unmutevoice @Ryu...#5498__**")
		.addField("- defean :", "**Give A mentioned user server defean**, **__Example: #defean @Ryu...#5498__**")
		.addField("- undefean :", "**Undefean A mentioned user**, **__Example: #undefean @Ryu...#5498__**")
		.addField("- voicekick :", "**Kick A mentioned user from the current voice channel**, **__Example: #voicekick @Ryu...#5498__**")
		.addField("- move :", "**Move A mentioned user to ur voice channel**, **__Example: #move @Ryu...#5498__**")
		.addField("- moveall :", "**Move All users to ur voice channel.**")
		.addField("- clear :", "**Clear A current chat**, **__Example: #clear 22__**")
		.addField("- ct :", "**Creat A text channel**, **__Example: #ct ryu_chat__**")
		.addField("- cv :", "**Creat A voice channel**, **__Example: #ct ryu_voice__**")
		.addField("- v :", "**Creat A temporary voice channel**, **__Example: #v ryu__**")
		.addField("- delete :", "**Remove A text or voice channel**, **__Example: #delete ryu_voice__**")
		...
		.setFooter("For more informations about my commands: <@431150885549113344>.")
        .setThumbnail(sicon)
